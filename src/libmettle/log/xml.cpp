...
namespace mettle::log {
  ...
  namespace {
    ...
    // doesn't play nice with `indenting_ostream`. Just escape them for
    // simplicity.
    ...
    // Match anything that 1) starts with "xml" or anything other than a letter
    // or underscore, or 2) contains anything other than alphanumerics,
