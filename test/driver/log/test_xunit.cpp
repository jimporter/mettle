    ...
    _.test("passing run", [](logger_factory &f) {
      ...
      expect(f.ss->str(), equal_to(
        ...
        "<testsuites failures=\"0\" skipped=\"0\" tests=\"4\" "
                    "time=\"0.400000\">\n"
        "  <testsuite failures=\"0\" file=\"file.cpp\" "
                     "name=\"suite &gt; subsuite\" skipped=\"0\" tests=\"1\" "
                     "time=\"0.100000\">\n"
        ...
        "    </testcase>\n"
        "  </testsuite>\n"
        "  <testsuite failures=\"0\" file=\"file.cpp\" name=\"suite\" "
                     "skipped=\"0\" tests=\"2\" time=\"0.200000\">\n"
        "    <testcase file=\"file.cpp\" line=\"10\" name=\"test 1\" "
                      "time=\"0.100000\"/>\n"
        "    <testcase file=\"file.cpp\" line=\"20\" name=\"test 2\" "
                      "time=\"0.100000\"/>\n"
        "  </testsuite>\n"
        "  <testsuite failures=\"0\" file=\"file.cpp\" name=\"second suite\" "
    ...
    _.test("failing run", [](logger_factory &f) {
      ...
      expect(f.ss->str(), equal_to(
        ...
        "<testsuites failures=\"2\" skipped=\"1\" tests=\"4\" "
                    "time=\"0.300000\">\n"
        "  <testsuite failures=\"0\" file=\"file.cpp\" "
                     "name=\"suite &gt; subsuite\" skipped=\"1\" tests=\"1\" "
                     "time=\"0.000000\">\n"
        "    <testcase file=\"file.cpp\" line=\"30\" name=\"test 3\">\n"
        "      <skipped message=\"message&#10;more\"/>\n"
        "    </testcase>\n"
        "  </testsuite>\n"
        "  <testsuite failures=\"1\" file=\"file.cpp\" name=\"suite\" "
                     "skipped=\"0\" tests=\"2\" time=\"0.200000\">\n"
        "    <testcase file=\"file.cpp\" line=\"10\" name=\"test 1\" "
                      "time=\"0.100000\">\n"
        "      <system-out>\n"
        ...
        "    <testcase file=\"file.cpp\" line=\"20\" name=\"test 2\" "
                      "time=\"0.100000\">\n"
        "      <failure message=\"desc (file.cpp:22)&#10;error\"/>\n"
        "    </testcase>\n"
        "  </testsuite>\n"
        "  <testsuite failures=\"1\" file=\"file.cpp\" name=\"second suite\" "
                     "skipped=\"0\" tests=\"1\" time=\"0.100000\">\n"
        "    <testcase file=\"file.cpp\" line=\"40\" name=\"test 4\" "
                      "time=\"0.100000\">\n"
        "      <failure message=\"desc (file.cpp:44)&#10;error&#10;more\"/>\n"
        "      <system-out>\n"
        "        standard output\n"
        "      </system-out>\n"
        "      <system-err>\n"
    ...
    _.test("failing file run", [](logger_factory &f) {
      ...
      expect(f.ss->str(), equal_to(
        ...
        "<testsuites failures=\"1\" skipped=\"1\" tests=\"5\" "
                    "time=\"0.300000\">\n"
        "  <testsuite failures=\"1\" file=\"file.cpp\" "
                     "name=\"file `file.cpp`\" tests=\"1\" time=\"0\">\n"
